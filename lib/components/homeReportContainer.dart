      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(
                child: AutoSizeText(formarCurrency(transactionController.total),
                    style: TextStyle(
                        color: whiteColor,
                        fontSize: 30,
                        fontWeight: FontWeight.bold),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: AutoSizeText(
                    formarCurrency(transactionController.totalIncome),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: AutoSizeText(
                    formarCurrency(transactionController.totalExpense),
                    style: TextStyle(color: whiteColor, fontSize: 20),
                    maxLines: 2,
                    textAlign: TextAlign.center,
                  ),
